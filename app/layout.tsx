    ...
    >
      <body>
        {/*
          ...
          FIRST VIEWPORT: full-bleed hero, WebGL brass aura tracking pointer/scroll behind an oversized
          per-character name reveal, one mono line of role, two rectangular CTAs bottom-left.
